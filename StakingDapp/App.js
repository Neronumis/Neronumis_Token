...
const App = (): Node => {
	...
	function clickActionfe_1__s_c78_d0b6409d_k_c78_8da675d7_i_c78_74805029_i_c10_48f532f6_i_c14_e8969b05_i_c14_243b28f4(e){
		if(!(account === false)
		) {
			cryptoAdmin(instance, {add:'0xdec594Fb53B0c7fC78C198D9dA715049b46b0250', json:TokenERC20}, 'approve', function(){}
			, function(e1){
			}, [{k:{name:"Approval", conditions:['0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8', '0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8']}, f:function(){
			cryptoAdmin(instance, {add:'0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8', json:Staking}, 'stake', function(){}
			, function(e2){
			}, [{k:{name:"Staked", conditions:['0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8']}, f:function(){
			cryptoAdmin(instance, {add:'0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8', json:Staking}, 'stake', function(){}
			, function(e3){
			}, [], ethers.BigNumber.from('0'));}}], ethers.BigNumber.from( makeADecimalTextIntoLongText(textToDecimal(inputValues['fe 1 _s c78_d0b6409d k c78_8da675d7 i c78_74805029 i c10_48f532f6 i c14_53456f04 i c14_11be33c5']).toString(), ethers.BigNumber.from('18').toNumber()) ));}}], '0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8', ethers.BigNumber.from( makeADecimalTextIntoLongText(textToDecimal(inputValues['fe 1 _s c78_d0b6409d k c78_8da675d7 i c78_74805029 i c10_48f532f6 i c14_53456f04 i c14_11be33c5']).toString(), ethers.BigNumber.from('18').toNumber()) ));
		}else{
			connectWallet(); 
		};
		e.stopPropagation();
	}
	function clickActionfe_1__s_c78_d0b6409d_k_c78_8da675d7_i_c78_74805029_i_c14_73be1183_i_c14_e8969b05_i_c14_243b28f4(e){
		if(!(account === false)
		) {
			cryptoAdmin(instance, {add:'0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8', json:Staking}, 'withdrawInterestWithoutUnstaking', function(){}
			, function(e1){
			}, [{k:{name:"Staked", conditions:['0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8']}, f:function(){
			cryptoAdmin(instance, {add:'0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8', json:Staking}, 'withdrawInterestWithoutUnstaking', function(){}
			, function(e2){
			}, [], ethers.BigNumber.from( makeADecimalTextIntoLongText(textToDecimal(inputValues['fe 1 _s c78_d0b6409d k c78_8da675d7 i c78_74805029 i c14_73be1183 i c14_53456f04 i c14_11be33c5']).toString(), ethers.BigNumber.from('18').toNumber()) ));}}], ethers.BigNumber.from( makeADecimalTextIntoLongText(textToDecimal(inputValues['fe 1 _s c78_d0b6409d k c78_8da675d7 i c78_74805029 i c14_73be1183 i c14_53456f04 i c14_11be33c5']).toString(), ethers.BigNumber.from('18').toNumber()) ));
		}else{
			connectWallet(); 
		};
		e.stopPropagation();
	}
	function clickActionfe_1__s_c78_d0b6409d_k_c78_8da675d7_i_c78_74805029_i_c14_f6014b54_i_c14_e8969b05_i_c14_243b28f4(e){
		if(!(account === false)
		) {
			cryptoAdmin(instance, {add:'0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8', json:Staking}, 'unstake', function(){}
			, function(e1){
			}, [{k:{name:"Staked", conditions:['0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8']}, f:function(){
			cryptoAdmin(instance, {add:'0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8', json:Staking}, 'unstake', function(){}
			, function(e2){
			}, [], ethers.BigNumber.from( makeADecimalTextIntoLongText(textToDecimal(inputValues['fe 1 _s c78_d0b6409d k c78_8da675d7 i c78_74805029 i c14_f6014b54 i c14_53456f04 i c14_11be33c5']).toString(), ethers.BigNumber.from('18').toNumber()) ));}}], ethers.BigNumber.from( makeADecimalTextIntoLongText(textToDecimal(inputValues['fe 1 _s c78_d0b6409d k c78_8da675d7 i c78_74805029 i c14_f6014b54 i c14_53456f04 i c14_11be33c5']).toString(), ethers.BigNumber.from('18').toNumber()) ));
		}else{
			connectWallet(); 
		};
		e.stopPropagation();
			...
			signer.getAddress().then(function(account){
				...
				provider.getNetwork().then(function(network){
			        ...
			        if (network.chainId !== 80001){
			          if (window.ethereum){window.ethereum.request({method: 'wallet_addEthereumChain',params: [{chainId: `0x${Number(80001).toString(16)}`,
                chainName: 'Mumbai',
                nativeCurrency: {
...
<button style={{color:'rgb(255, 255, 255)', fontWeight:(1 ? 'bold' : 'normal'), backgroundColor:'rgb(68, 68, 68)', cursor:'pointer'}} className='btn'  onClick={clickActioncn_c97_2eb6bd27_nv_i_c1_3a5a4a1e} ><Icon height={'20px'} icon={'logos:ethereum-color'} style={{color:'rgb(141, 141, 141)'}} /> {(!(account === false) ? (chainId.eq(ethers.BigNumber.from(80001)) ? shortenName(account) : ('Connect to the ' + 'Mumbai' + ' chain')) : 'Connect Wallet')}</button>
		</nav>)
	}
			...
			<div><div style={{backgroundColor:'rgb(57, 62, 70)', borderStyle:'solid', borderWidth:1, borderColor:'rgb(57, 62, 70)', borderRadius:'0.90em'}} className=' mt-1 mb-1 ml-0 ml-md-0 mr-0 container-fluid'>
				<div><div className='row justify-content-start align-items-start'>
					<div className=' col-12 col-md-4'><div style={{backgroundColor:'rgb(57, 62, 70)', borderStyle:'solid', borderWidth:1, borderColor:'rgb(57, 62, 70)', borderRadius:'0.90em'}} className=' mt-1 mb-1 ml-0 ml-md-0 mr-0 container-fluid'>
						...
						<div><div className='row justify-content-start align-items-start'>
							<div className=' col-12 text-center' style={{borderWidth:0, padding:10}}><span key={0} style={{color:'rgb(255, 255, 255)'}}><i><span style={{backgroundColor:'rgb(57, 62, 70)'}}><span style={{fontSize:'0.8em'}}><span style={{fontFamily:'Cabin'}}>Stake your NERO to receive 38,42% fixed APY</span></span></span></i></span>
							</div>
						</div></div>
						<div><div className='row no-gutters justify-content-start align-items-start'>
							...
							<div className=' col-5text-left' style={{lineHeight:'1.67em', borderWidth:0, padding:0}}>
								<span key={0} style={{color:'rgb(44, 204, 195)'}}>{(ethers.BigNumber.from('18').gt(ethers.BigNumber.from('8')) ? function(outputTypeList, pathDownList){ var out = getValueFromExistingSmartContract(instance, account, '0xdec594Fb53B0c7fC78C198D9dA715049b46b0250', TokenERC20, 'balanceOf', [{t:'Address'}], outputTypeList, chainInfo, setChainInfo, [], account, []); if (out.checked){return out[0];}else{return defaultValue(outputTypeList[0], pathDownList)}}([{t:'UInteger'}], []).div(ethers.BigNumber.from('10').pow(ethers.BigNumber.from('18').sub(ethers.BigNumber.from('8')))).toNumber()/(10 ** ethers.BigNumber.from('8').toNumber()) : function(outputTypeList, pathDownList){ var out = getValueFromExistingSmartContract(instance, account, '0xdec594Fb53B0c7fC78C198D9dA715049b46b0250', TokenERC20, 'balanceOf', [{t:'Address'}], outputTypeList, chainInfo, setChainInfo, [], account, []); if (out.checked){return out[0];}else{return defaultValue(outputTypeList[0], pathDownList)}}([{t:'UInteger'}], []).toNumber() / (10 ** ethers.BigNumber.from('18').toNumber())).toFixed(ethers.BigNumber.from('8').toNumber() > 100 ? 100 : ethers.BigNumber.from('8').toNumber())}</span>
							</div>
						</div></div>
						<div><div className='row no-gutters justify-content-start align-items-start'>
							<div  className=' col-12 mt-3 mb-2 ml-0 mr-0' style={{height:'100%', padding:'0'}}><DecimalInputRecall defaultValue={0} className='form-control text-center' style={{placeholder:'', backgroundColor:'rgb(57, 62, 70)', color:'rgb(255, 255, 255)', borderStyle:'solid', borderWidth:1, borderColor:'rgb(255, 255, 255)', disabled:false, padding:6, height:'100%'}} gVs={[]} setInputValues={setInputValues} inputValues={inputValues} idNos={'fe 1 _s c78_d0b6409d k c78_8da675d7 i c78_74805029 i c10_48f532f6 i c14_53456f04 i c14_11be33c5'}/>{function(){ var p = []; var valueOut = inputValues['fe 1 _s c78_d0b6409d k c78_8da675d7 i c78_74805029 i c10_48f532f6 i c14_53456f04 i c14_11be33c5']; if (!isDecimalText(valueOut) && valueOut){ p.push('Not a Decimal');};  if (p.length > 0){ return <center><p style={{color:'red'}}>{p.join(', ')}</p></center>}else{ return null; }}()}</div>
						</div></div>
						<div><div className='row no-gutters justify-content-start align-items-start'>
							<button style={{cursor:'pointer'}} className='btn btn-info col-12 mt-2 mb-4'  onClick={clickActionfe_1__s_c78_d0b6409d_k_c78_8da675d7_i_c78_74805029_i_c10_48f532f6_i_c14_e8969b05_i_c14_243b28f4} ><Icon height={'20px'} icon={'openmoji:rocket'} /> {'Stake NERO'}</button>
						</div></div>
					</div></div>
					<div className=' col-12 col-md-4'><div style={{backgroundColor:'rgb(57, 62, 70)', borderStyle:'solid', borderWidth:1, borderColor:'rgb(57, 62, 70)', borderRadius:'0.90em'}} className=' mt-1 mb-1 ml-0 ml-md-0 mr-0 container-fluid'>
						<div><div className='row justify-content-start align-items-start'>
						...
						<div><div className='row justify-content-start align-items-start'>
							<div className=' col-12 text-center' style={{borderWidth:0, padding:10}}><span key={0} style={{color:'rgb(255, 255, 255)'}}><i><span style={{backgroundColor:'rgb(57, 62, 70)'}}><span style={{fontSize:'0.8em'}}><span style={{fontFamily:'Cabin'}}>Claim your rewards only</span></span></span></i></span>
							</div>
						</div></div>
						<div><div className='row no-gutters justify-content-start align-items-start'>
					...
					<div className=' col-12 col-md-4'><div style={{backgroundColor:'rgb(57, 62, 70)', borderStyle:'solid', borderWidth:1, borderColor:'rgb(57, 62, 70)', borderRadius:'0.90em'}} className=' mt-1 mb-1 ml-0 ml-md-0 mr-0 container-fluid'>
						...
						<div><div className='row justify-content-start align-items-start'>
							<div className=' col-12 text-center' style={{borderWidth:0, padding:10}}><span key={0} style={{color:'rgb(255, 255, 255)'}}><i><span style={{backgroundColor:'rgb(57, 62, 70)'}}><span style={{fontSize:'0.8em'}}><span style={{fontFamily:'Nunito, sans-serif'}}>Unstake your NERO and claim your rew</span></span></span></i></span>
							</div>
						</div></div>
						<div><div className='row no-gutters justify-content-start align-items-start'>
							...
							<div className=' col-5text-left' style={{lineHeight:'1.67em', borderWidth:0, padding:0}}>
								<span key={0} style={{color:'rgb(44, 204, 195)'}}>{(ethers.BigNumber.from('18').gt(ethers.BigNumber.from('8')) ? function(outputTypeList, pathDownList){ var out = getValueFromExistingSmartContract(instance, account, '0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8', Staking, 'addressMap', [{t:'Address'}], outputTypeList, chainInfo, setChainInfo, [], account, []); if (out.checked){return out[1];}else{return defaultValue(outputTypeList[1], pathDownList)}}([{t:'UInteger'}, {t:'UInteger'}, {t:'UInteger'}, {t:'UInteger'}, {t:'UInteger'}], []).div(ethers.BigNumber.from('10').pow(ethers.BigNumber.from('18').sub(ethers.BigNumber.from('8')))).toNumber()/(10 ** ethers.BigNumber.from('8').toNumber()) : function(outputTypeList, pathDownList){ var out = getValueFromExistingSmartContract(instance, account, '0x53bF176BCbCE4078B393A74A3D496316f9d2eBf8', Staking, 'addressMap', [{t:'Address'}], outputTypeList, chainInfo, setChainInfo, [], account, []); if (out.checked){return out[1];}else{return defaultValue(outputTypeList[1], pathDownList)}}([{t:'UInteger'}, {t:'UInteger'}, {t:'UInteger'}, {t:'UInteger'}, {t:'UInteger'}], []).toNumber() / (10 ** ethers.BigNumber.from('18').toNumber())).toFixed(ethers.BigNumber.from('8').toNumber() > 100 ? 100 : ethers.BigNumber.from('8').toNumber())}</span><br/>
							</div>
						</div></div>
						<div><div className='row no-gutters justify-content-start align-items-start'>
							<div  className=' col-12 mt-3 mb-2 ml-0 mr-0' style={{height:'100%', padding:'0'}}><DecimalInputRecall defaultValue={0} className='form-control text-center' style={{placeholder:'', backgroundColor:'rgb(57, 62, 70)', color:'rgb(255, 255, 255)', borderStyle:'solid', borderWidth:1, borderColor:'rgb(255, 255, 255)', disabled:false, padding:6, height:'100%'}} gVs={[]} setInputValues={setInputValues} inputValues={inputValues} idNos={'fe 1 _s c78_d0b6409d k c78_8da675d7 i c78_74805029 i c14_f6014b54 i c14_53456f04 i c14_11be33c5'}/>{function(){ var p = []; var valueOut = inputValues['fe 1 _s c78_d0b6409d k c78_8da675d7 i c78_74805029 i c14_f6014b54 i c14_53456f04 i c14_11be33c5']; if (!isDecimalText(valueOut) && valueOut){ p.push('Not a Decimal');};  if (p.length > 0){ return <center><p style={{color:'red'}}>{p.join(', ')}</p></center>}else{ return null; }}()}</div>
						</div></div>
						<div><div className='row no-gutters justify-content-start align-items-start'>
							<button style={{cursor:'pointer'}} className='btn btn-info col-12 mt-2 mb-4'  onClick={clickActionfe_1__s_c78_d0b6409d_k_c78_8da675d7_i_c78_74805029_i_c14_f6014b54_i_c14_e8969b05_i_c14_243b28f4} ><Icon height={'20px'} icon={'carbon:send-alt-filled'} /> {'Withdrawal'}</button>
						</div></div>
					</div></div>
				</div></div>
			</div></div>
